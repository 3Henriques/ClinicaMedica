...
export const consultasMock: Consulta[] = [
  ...
  { numero: 9, clienteId: 6, medicoId: 2, especialidadeId: 2, data: fmt(hoje), horaInicio: "16:00", horaFim: "16:30", tipo: "RETORNO", status: "R", tipoPagamento: "DINHEIRO", procedimentos: "Acompanhamento" },
